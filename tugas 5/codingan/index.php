                ...
                <form method="POST" action="index.php">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nim" name="nim" required placeholder="Contoh: 2402001" value="<?php echo isset($_POST['nim']) ? htmlspecialchars($_POST['nim']) : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama*</label>
                            <input type="text" class="form-control" id="nama" name="nama" required placeholder="Contoh: Adrian Saputra" value="<?php echo isset($_POST['nama']) ? htmlspecialchars($_POST['nama']) : ''; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="alamat" class="form-label">Alamat</label>
                            <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Contoh: Bogares kidul rt16/rw003" value="<?php echo isset($_POST['alamat']) ? htmlspecialchars($_POST['alamat']) : ''; ?>">
                        </div>
                    </div>
